...
export default function About() {
  return (
    <main className="pb-4 md:pb-10">
      ...
      <div className="my-2">
        I'm interested in AI and how it can be applied to accelerate engineering; Energy and how we climb the Kardashev scale; Nanotech 
        and how we gain &quot;complete control over the structure of matter;&quot; and Space Exploration and how we become a multiplanetary species.
      </div>
      <p>
